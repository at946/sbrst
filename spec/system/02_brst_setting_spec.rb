...
feature '02_ブレストの条件を設定できること', type: :system, js: true do
  ...
  scenario "【ブレスト設定ページ】で【ブレストしたいこと】を入力できること" do
    visit set_path
  ...
  scenario "【ブレスト設定ページ】で【ブレストを始める】を選択した場合、【ブレストページ】へ遷移できること" do
    visit set_path
    fill_in :setting_problem, with: @problem
    fill_in :setting_limit_time, with: @limit_time
    click_on :start_brst_button
  ...
  scenario "【ブレストページ】で【ブレスト設定ページ】で設定した【ブレストしたいこと】が表示されていること" do
    visit set_path
    fill_in :setting_problem, with: @problem
    fill_in :setting_limit_time, with: @limit_time
    click_on :start_brst_button
  ...
  scenario "【ブレストページ】で【ブレスト設定ページ】で設定した【制限時間】が表示されていること" do
    visit set_path
    fill_in :setting_problem, with: @problem
    fill_in :setting_limit_time, with: 1
    click_on :start_brst_button
